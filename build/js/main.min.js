...
/* harmony import */ var _modules_show_card_coaches_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/show-card-coaches.js */ "./js/modules/show-card-coaches.js");
/* harmony import */ var _modules_swipers_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/swipers.js */ "./js/modules/swipers.js");
/* harmony import */ var _modules_toggle_tab_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/toggle-tab.js */ "./js/modules/toggle-tab.js");
/* harmony import */ var _modules_find_videos_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/find-videos.js */ "./js/modules/find-videos.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_find_videos_js__WEBPACK_IMPORTED_MODULE_5__["findVideos"])(); // Modules
  // ---------------------------------
  // все скрипты должны быть в обработчике 'DOMContentLoaded', но не все в 'load'
  // в load следует добавить скрипты, не участвующие в работе первого экрана

  window.addEventListener('load', function () {
    Object(_modules_swipers_js__WEBPACK_IMPORTED_MODULE_3__["switchSwiper"])();
    Object(_modules_show_card_coaches_js__WEBPACK_IMPORTED_MODULE_2__["showCardCoaches"])();
    Object(_modules_toggle_tab_js__WEBPACK_IMPORTED_MODULE_4__["toggleTab"])();
...
function generateURL(id) {
  ...
  return "https://youtube.com/embed/".concat(id).concat(query);
}
...
/*!*****************************************!*\
  !*** ./js/modules/show-card-coaches.js ***!
  \*****************************************/
/*! exports provided: showCardCoaches */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "showCardCoaches", function() { return showCardCoaches; });
...
var coachCardElementsCollection = document.querySelectorAll('.coaches__card');

var showCardCoaches = function showCardCoaches() {
  var _iterator = _createForOfIteratorHelper(coachCardElementsCollection),
      _step;

  try {
    var _loop = function _loop() {
      var card = _step.value;
      var cardInfo = card.querySelector('.coaches__info');
      var cardPhotoHeading = card.querySelector('.coaches__photo h2');
...
/*!*******************************!*\
  !*** ./js/modules/swipers.js ***!
  \*******************************/
/*! exports provided: switchSwiper */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "switchSwiper", function() { return switchSwiper; });
var commentsSwiperPrevSlideButton = document.querySelector('.comments__swiper-button-prev');
var commentsSwiperNextSlideButton = document.querySelector('.comments__swiper-button-next');
var coachesSwiperPrevSlideButton = document.querySelector('.coaches__swiper-button-prev');
var coachesSwiperNextSlideButton = document.querySelector('.coaches__swiper-button-next');

var initСommentsSwiper = function initСommentsSwiper() {
  commentsSwiperPrevSlideButton.style.display = 'block';
  commentsSwiperNextSlideButton.style.display = 'block'; // eslint-disable-next-line no-undef

  var commentsSwiper = new Swiper('.comments__list .swiper', {
    spaceBetween: 20
  });
  commentsSwiperPrevSlideButton.addEventListener('click', function () {
    commentsSwiper.slidePrev();
  });
  commentsSwiperNextSlideButton.addEventListener('click', function () {
    commentsSwiper.slideNext();
  });
  commentsSwiperPrevSlideButton.addEventListener('keydown', function (evt) {
    if (evt.keyCode === 13) {
      commentsSwiper.slidePrev();
    }
  });
  commentsSwiperNextSlideButton.addEventListener('keydown', function (evt) {
    if (evt.keyCode === 13) {
      commentsSwiper.slideNext();
    }
  });
...
var initCoachesSwiper = function initCoachesSwiper() {
  coachesSwiperPrevSlideButton.style.display = 'block';
  coachesSwiperNextSlideButton.style.display = 'block'; // eslint-disable-next-line no-undef

  var coachesSwiper = new Swiper('.coaches__list .swiper', {
    spaceBetween: 40,
    slidesPerView: 1,
    rewind: true,
    breakpoints: {
  ...
  coachesSwiperPrevSlideButton.addEventListener('click', function () {
    coachesSwiper.slidePrev();
  });
  coachesSwiperNextSlideButton.addEventListener('click', function () {
    coachesSwiper.slideNext();
  });
  coachesSwiperPrevSlideButton.addEventListener('keydown', function (evt) {
    if (evt.keyCode === 13) {
      coachesSwiper.slidePrev();
    }
  });
  coachesSwiperNextSlideButton.addEventListener('keydown', function (evt) {
    if (evt.keyCode === 13) {
      coachesSwiper.slideNext();
    }
  });
...
var subscriptionsInfoElementsCollection = document.querySelector('.subscriptions__info').children;
var subscriptionsTabElementsCollection = document.querySelector('.subscriptions__options').children;

var hideAllSubscriptionsInfo = function hideAllSubscriptionsInfo() {
  var _iterator = _createForOfIteratorHelper(subscriptionsInfoElementsCollection),
      _step;
...
var deactivateAllSubscriptionsTabsState = function deactivateAllSubscriptionsTabsState() {
  var _iterator2 = _createForOfIteratorHelper(subscriptionsTabElementsCollection),
      _step2;
...
var setSubscriptionsTabs = function setSubscriptionsTabs() {
  var _iterator3 = _createForOfIteratorHelper(subscriptionsTabElementsCollection),
      _step3;
  ...
  try {
    for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
      ...
      tab.querySelector('a').addEventListener('click', function (evt) {
        ...
        var macthingSubscriptionsInfoElement = document.getElementById(evt.target.href.split('#').pop());
